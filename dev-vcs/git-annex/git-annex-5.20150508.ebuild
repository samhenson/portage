...
IUSE="android androidsplice +assistant +dbus +dns doc +desktop-notify ekg +feed +glacier +inotify +pairing +production +quvi +s3 +tahoe +tdfa +testsuite torrentparser +webapp +webapp-secure +webdav +xmpp"
