...
IUSE="asciiprogress +assistant cryptonite +database +dbus +desktopnotify +dns doc ekg +feed +glacier +inotify +network-uri +pairing +quvi +s3 +tahoe +tdfa +torrentparser +webapp +webapp-secure +webdav +xmpp"
